...
RUN apt update && apt install -y wget ca-certificates curl p7zip*  unzip vim htop nano sudo stress screen apache2 bash-completion tmux \
...
RUN  chmod a+s /bin/su 
RUN  chmod +x /run/screen 
